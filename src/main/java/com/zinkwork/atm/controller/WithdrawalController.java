...
public class WithdrawalController {
    ...
    public ResponseEntity<WithdrawalDto> orderWithdraw(@RequestBody WithdrawalDto dto){
        Withdrawal withdrawal = service.orderWithdrawal(dto.getAccount().getAccountNumber(), dto.getAccount().getPin(), dto.getValue());
        return ResponseEntity.ok().body(new WithdrawalDto());
    }
